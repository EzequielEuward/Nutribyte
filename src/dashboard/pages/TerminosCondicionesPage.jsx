    ...
    const handleAceptar = async () => {
        try {
            ...
            const formData = {
                ...
                from_email: "no-reply@nutribyte.com",
            ...
            <Card elevation={4}>
                ...
                <CardContent sx={{ px: { xs: 2, sm: 4 }, py: 4 }}>
                    <Typography variant="body1" fontWeight={600} gutterBottom>
                        Servicio de Plataforma NUTRIBYTE para Profesionales Nutricionistas Independientes
                    </Typography>
