    ...
    const handleAceptar = async () => {
        try {
            ...
            const formData = {
                ...
                to_name: "Equipo de NUTRIBITE",
                from_name: "Usuario Prueba",
                from_email: "no-reply@nutribite.com",
            ...
            <Card elevation={4}>
                ...
                <CardContent sx={{ px: { xs: 2, sm: 4 }, py: 4 }}>
                    <Typography variant="body1" fontWeight={600} gutterBottom>
                        Servicio de Plataforma NUTRIBITE para Profesionales Nutricionistas Independientes
                    </Typography>
